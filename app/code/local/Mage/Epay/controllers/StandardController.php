...
class Mage_Epay_StandardController extends Mage_Core_Controller_Front_Action
{
    ...
    {   
        ...
        //
        // Validate currency
		if(((int)$payment->convertToEpayCurrency($this->_orderObj->getBaseCurrency()->getCode())) != (int)$_GET["currency"] && ((int)$payment->convertToEpayCurrency($this->_orderObj->getOrderCurrency()->getCode())) != (int)$_GET["currency"])
		{
			echo "<h1>An error occured!</h1>";
