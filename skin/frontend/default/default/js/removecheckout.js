var Pinknose = Class.create(Checkout, {
...
var PinknoseShippingMethod = Class.create(ShippingMethod , {
...
var PinknoseReview = Class.create(Review,{
	...
	save: function(){
        ...
        var params = 'payment[method]=epay_standard';
